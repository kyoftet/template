...
// SetMailAddress sets the "mail_address" field.
func (m *UserMutation) SetMailAddress(s string) {
	m.mail_address = &s
}

// MailAddress returns the value of the "mail_address" field in the mutation.
...
// OldMailAddress returns the old "mail_address" field's value of the User entity.
// If the User object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
...
// ResetMailAddress resets all changes to the "mail_address" field.
