...
type User struct {
	...
	// MailAddress holds the value of the "mail_address" field.
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldUserID, user.FieldName, user.FieldPassword, user.FieldMailAddress, user.FieldIntroduction:
...
func (u *User) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case user.FieldMailAddress:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field mail_address", values[i])
			} else if value.Valid {
...
func (u *User) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("mail_address=")
